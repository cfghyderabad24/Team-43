...
const Profile = () => {
  ...
  return (
    <div>
      <h1 className='text-6xl text-red-600 text-center my-2 font-serif hover:text-amber-400 animate-pulse'>Profile</h1>
        ...
        <div className='w-[75%] md:w-[50%] p-10 flex md:justify-end justify-center'>
          <form className='bg-red-600 p-10 md:w-[75%] w-full rounded-lg'>
            ...
            <div className='mt-12 w-full'>
              <button type='submit' onClick={(e) => updateData(e)} className='w-full px-4 py-2 bg-amber-300 text-red-600 rounded-md block mx-auto'>Save</button>
            </div>
          </form>
        </div>
